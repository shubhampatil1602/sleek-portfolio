...
export function Projects({
  ...
  return (
    <motion.div className="my-4 border-y border-neutral-100 px-4 py-6 shadow-sectionInset dark:border-neutral-800 dark:shadow-sectionInsetDark">
      ...
      <div className="grid grid-cols-1 gap-4 py-4 md:grid-cols-3">
        {projects.map((project, idx) => (
          <motion.div
            ...
            key={project.title}
            className="group relative mb-4 rounded-2xl delay-100 hover:shadow-custom"
          >
              ...
              <div className="flex flex-1 flex-col justify-between py-4 transition-all duration-300 group-hover:px-4">
                <div className="flex items-end justify-between">
                  ...
                  <button
                    ...
                    className="z-20 flex items-center justify-center rounded-full bg-neutral-100 p-1.5 text-neutral-500 transition duration-200 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-700"
                  >
